...
public class frmDeposit extends javax.swing.JFrame {
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        userAccount.deposit(Float.parseFloat(txtAmount.getText()));
        clsConnection connection = new clsConnection();
        connection.ModifyDataInDB(userAccount);
        connection.addUserMovementToDB(userAccount, "Deposit");
        JOptionPane.showMessageDialog(null, "Succesful transaction!", "Deposit", JOptionPane.INFORMATION_MESSAGE);
